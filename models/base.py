...
class BaseLearner(object):
    ...
    def _evaluate(self, y_pred, y_true):
        ...
        # ret["top{}".format(self.topk)] 由于cifar10 数据量少，有top2，这里方便全部统一成top5
        ret["top5"] = np.around(
    ...
    def _extract_vectors(self, loader, rotate_number=None):
        self._network.eval()
        vectors, targets = [], []
        for _, _inputs, _targets in loader:
            if rotate_number != None:
                _inputs = torch.rot90(_inputs, rotate_number, dims=(2, 3))
                _targets = 4 * _targets + rotate_number
